...
function MyCard () {
  return (
    <Card className='custom-card my-card' style={{ marginBottom: '20px' }}>
      <Card.Img
        variant='top'
        src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRflgyRGKBIWj2eOqDdn3L2-b_sjx1R0_BiAiK40iA10Xxu2lfv0Q2PtxuoS-y2J4O0fJU&usqp=CAU'
      />
      <Card.Body>
